/**
 * RFC 3526 MODP Group 14 (2048-bit) parameters for ElGamal encryption.
 *
 * This is a safe prime: P = 2q + 1 where q is also prime (Sophie Germain prime).
 * Using the same constants as the backend for interoperability.
 */
...
/** Generator g = 2 (standard for RFC 3526) */
export const g = 2n;

/** Sophie Germain prime q = (P - 1) / 2 - the order of the subgroup of quadratic residues */
